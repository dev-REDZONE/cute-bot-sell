...
execute(message, args) {
    ...
    if (isNaN(args[0])) return attentionembed(message,"That's not a Number between **0 & 500**");
    //if args is not a Number between 150 and 0 return error
    if (parseInt(args[0]) < 0 || parseInt(args[0]) > 500)
      return attentionembed(message,"That's not a Number between **0 & 500**");
